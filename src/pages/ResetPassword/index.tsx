...
function Main() {
  ...
  useEffect(() => {
    setPasswordsMatch(password === confirmPass || confirmPass === "");
            ...
            <div className="flex h-screen py-5 my-10 xl:h-auto xl:py-0 xl:my-0">
              <div className="w-full px-5 py-8 mx-auto my-auto bg-white rounded-md shadow-md xl:ml-20 dark:bg-darkmode-600 xl:bg-transparent sm:px-8 xl:p-0 xl:shadow-none sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <div className="mt-8 intro-x">             
                  <FormInput
                    type="password"
                    className="block px-4 py-3 intro-x min-w-full xl:min-w-[350px] form-input ${!passwordsMatch ? 'border-red-500' : ''}"
                ...
                <div className="mt-8 intro-x">             
                  <FormInput
                    type="password"
                    className={`block px-4 py-3 intro-x min-w-full xl:min-w-[350px] ${!passwordsMatch ? 'border-red-500' : ''}`}                    placeholder="Confirm Password"
                    value={confirmPass}
                    required
