...
function Main() {
  ...
  const [formattedMenuAdmin, setFormattedMenuAdmin] = useState<
  Array<FormattedMenu | "divider">
>([]);
  ...
  useEffect(() => {
    ...
    if (formattedMenu.length > 0) {
      // Remove "divider" if it already exists
      const filteredMenu: any[] = formattedMenu.filter((_, index) => index >= 9);
  
      // Add formattedMenuAdmin as the last element
      setFormattedMenuAdmin(filteredMenu);
    }
  }, [formattedMenu]);
  

  console.log(formattedMenuAdmin)
      ...
      <div className="flex mt-[4.7rem] md:mt-0">
        ...
        <nav className="pr-5 pb-16 overflow-x-hidden hidden md:block w-[85px] xl:w-[230px]">
          ...
          <ul>
            ...
            formattedMenu.slice(0, 9).map((menu, menuKey) =>
              menu == "divider" ? (
                <Divider
                  type="li"
                  className={clsx([
            ...
            formattedMenuAdmin.map((menu, menuKey) =>
              menu == "divider" ? (
                <Divider
                  type="li"
                  className={clsx([
